...
function customSelectBoxForAyurGrid(data, thisData) {
    $(thisData).toggleClass(data + '-active');
    console.log($(thisData).children().attr('disabled'));
    if ($(thisData).children().attr('disabled') == "disabled") {
        console.log($(thisData).children().attr('disabled', false));
    } else {
        console.log($(thisData).children().attr('disabled', true));
    }
}