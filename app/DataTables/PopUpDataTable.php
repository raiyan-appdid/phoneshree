    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($value) {
                $edit_route = route('admin.popup.edit', $value->id);
                $edit_callback = 'setValue';
                $modal = '#edit-popup-modal';
                $delete_route = route('admin.popup.destroy', $value->id);
            ...
            $route = route('admin.popup.status');
